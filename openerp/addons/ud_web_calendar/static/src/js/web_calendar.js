...
openerp.ud_web_calendar = function(instance) {
    ...
    instance.web.views.add('calendar', 'instance.ud_web_calendar.CalendarView');

    instance.ud_web_calendar.CalendarView = instance.web.View.extend({
        template: "CalendarView",
        display_name: _lt('Calendar'),
        quick_create_instance: 'instance.ud_web_calendar.QuickCreate',
...
*/
        ...
        init_calendar: function() {
            ...
            if (!this.sidebar && this.options.$sidebar) {
                ...
                this.sidebar = new instance.ud_web_calendar.Sidebar(this);
     ...
     * @type {*}
     */
    instance.ud_web_calendar.QuickCreate = instance.web.Widget.extend({
    ...
    function widget_calendar_lazy_init() {
        ...
        instance.ud_web_calendar.FieldCalendarView = instance.ud_web_calendar.CalendarView.extend({

            init: function (parent) {
                this._super.apply(this, arguments);
                // Warning: this means only a field_widget should instanciate this Class
                this.field_widget = parent;
                this.quick_creatable = false;
            },
    ...
    instance.ud_web_calendar.BufferedDataSet = instance.web.BufferedDataSet.extend({
    ...
    instance.ud_web_calendar.fields_dataset = new instance.web.Registry({
        'many2many': 'instance.web.DataSetStatic',
        'one2many': 'instance.web.DataSetStatic',
    });


    function get_field_dataset_class(type) {
        var obj = instance.ud_web_calendar.fields_dataset.get_any([type]);
        if (!obj) {
     ...
     */
    instance.web.form.widgets.add("o2m_calendar", "instance.ud_web_calendar.FieldCalendar");

    instance.ud_web_calendar.FieldCalendar = instance.web.form.AbstractField.extend({

        disable_utility_classes: true,
        calendar_view_class: 'instance.ud_web_calendar.FieldCalendarView',
                ...
                this.field.relation,
                {
                    ...
                    create_function: function(data, options) {
                        ...
                        return self.dataset.create(data, options).done(function(r) {
                            ...
                            self.dataset.trigger("dataset_changed", r);
                            self.calendar_view.refresh_event(r);
                        });
                    },

                    read_function: function() {
                        return self.dataset.read_ids.apply(self.dataset, arguments);
                    },
    ...
    instance.ud_web_calendar.Sidebar = instance.web.Widget.extend({
        template: 'CalendarView.sidebar',
        
        start: function() {
            this._super();
            this.filter = new instance.ud_web_calendar.SidebarFilter(this, this.getParent());
            this.filter.appendTo(this.$el.find('.oe_calendar_filter'));
        }
    });
    instance.ud_web_calendar.SidebarFilter = instance.web.Widget.extend({
        events: {
